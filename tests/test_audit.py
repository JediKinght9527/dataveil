...
class TestAuditLogger:
    ...
    def test_query_by_status(self, audit):
        audit.log(
            request_id="req-1", method="POST", path="v1/messages",
            profile="work", provider="kimi", status_code=200, duration_ms=100,
        )
        audit.log(
            request_id="req-2", method="POST", path="v1/messages",
            profile="work", provider="kimi", status_code=500, duration_ms=50,
        )
    ...
    def test_query_by_profile(self, audit):
        ...
        audit.log(
            request_id="req-2", method="POST", path="v1/messages",
            profile="personal", provider="openai", status_code=200, duration_ms=50,
        )
